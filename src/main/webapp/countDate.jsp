...
<body>
	...
	<!-- 页头开始 -->
	<div class="head">
		<a href="#" style="">统计分析>时间段统计</a>
	</div>

	<div class="inquire">
		<li><span>开始时间：</span> <input type="text" class="demo-input "
			placeholder="请选择" id="test1"> <i
			class="glyphicon glyphicon-menu-down" id="one"></i> <span id="jieshu">结束时间：</span>
			<i class="glyphicon glyphicon-menu-down" id="tow"></i> <input
	...
	<script src="./js/countDate.js"></script>
</body>
