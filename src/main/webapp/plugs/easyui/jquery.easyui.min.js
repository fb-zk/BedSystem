 ...
 * 陈彪
 */
td.append("<div class=\"datagrid-cell\"><b><span></span></b><span class=\"datagrid-sort-icon\"></span></div>");
...
/**
 * 陈彪
 * 原 cell.css("text-align",(col.halign||col.align||""));
 */
 ...
 * 陈彪
 */
function _abc(_4e6,index){
	$(_4e6).datagrid("clearSelections");
	selectCheck(_4e6,index);
}
/**
 * 新增方法
 * 陈彪
 */
function selectCheck(_4e6,index){
	var opts=$.data(_4e6,"datagrid").options;
	var ck=opts.finder.getTr(_4e6,index).find("div.datagrid-cell-check input[type=checkbox]");
	if(ck.length>0)
	ck._propAttr("checked",true);
	opts.finder.getTr(_4e6,index).addClass("datagrid-row-selected");
	var _c4g = $.data(_4e6,"datagrid");
	if(opts.idField){
		_4ad(_c4g.selectedRows,opts.idField,_c4g.data.rows[index]);
		_4ad(_c4g.checkedRows,opts.idField,_c4g.data.rows[index]);
	}else{
		_4ad(_c4g.selectedRows,"id",_c4g.data.rows[index]);
	}
}
 ...
 * 陈彪
 */
function _abce(a,index){
	var opts=$.data(a,"datagrid").options;
	if(opts.singleSelect){//如果是单选
		$(a).datagrid("clearSelections");
		selectCheck(a,index);
		opts.onSelect.call(a,index,$.data(a,"datagrid").data.rows[index]);
	}
}
function _511(tr){
...
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"\">"+_66f+"</div></td>");
}
