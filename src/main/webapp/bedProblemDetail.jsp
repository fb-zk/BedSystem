			...
			<div class="remark" id="remark">
				...
				<c:if test="${detail.checkState==1 }">
					<button type="button" class="btn-primary4">
						<a href="${ctx }/maintain/checkYes?id=${detail.maintainId }">通过</a>
					</button>
					<button type="button" class="btn-primary4">
						<a href="${ctx }/maintain/checkNo?id=${detail.maintainId }">拒绝</a>
					</button>
				</c:if>
				<c:if test="${detail.checkState==2 and detail.maintainState==0}">
					<button type="button" class="btn-primary4">
						<a href="${ctx }/maintain/maintain?id=${detail.maintainId }">维修</a>
					</button>
				</c:if>
			</div>
		</div>
