...
.particulars1 {
	...
	<!-- 页头开始 -->
	<div class="head">
		<a href="./information.html" style="">统计分析>使用次数统计</a>
		<div></div>
	</div>
	...
	<div class="inquire">
		<div class="search">
			...
			<div class="content_input">
				<span id="phone">医院名称：</span> 
				<input type="text" class="search_field" placeholder="请输入医院名" id="bth9"> 
				<span id="name">陪护椅编号：</span> 
				<input type="text" class="search_field" placeholder="请输入编号" id="bth10"> 
				<span id="keshi">科室：</span>
				<input type="text" class="search_field" placeholder="请输入科室" id="bth11"> 
<%--				<span id="frequency">次数：</span> --%>
<%--				<input type="text" class="search_field" placeholder="请输入次数" id="bth12">--%>
	...
	<script src="./js/countTimes.js"></script>
</body>
